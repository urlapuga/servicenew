        ...
        <c:forEach items="${companies}" var="company">
            <tr>
                ...
                <form>
                    ...
                    <td><a href="<c:url value='/edit-company-${company.id}' />" target="_blank" class="btn btn-default">Изменить</a>
                    </td>
                </form>
            </tr>
        </c:forEach>
...
<table border="1">
    ...
    <c:forEach items="${result}" var="employees">
        <tr>
            ...
            <td><a href="<c:url value='/edit-company-${employees.id}' />" target="_blank"  class="btn btn-default">Изменить</a></td>
        </tr>
    </c:forEach>
    <tr bgcolor="#a9a9a9">
        <th>Имя</th>
...
<div id="positionsDiv">
    ...
    <table border="1">
        <c:forEach items="${positions}" var="p">
            <tr>
                <td>${p.name}</td>
                <td><a href="<c:url value='/delete-position-${p.id}' />" class="btn btn-danger custom-width">Удалить</a>
                </td>
            </tr>
        </c:forEach>
        <tr bgcolor="#f0ffff">
